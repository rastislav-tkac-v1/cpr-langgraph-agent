...
class Contract(BaseModel):
    ...
    customer_sign_date: date = Field(description='Date of the contract signature by customer')
    start_date: date = Field(description='Contract start date')
    end_date: Optional[date] = Field(description='Contract end date', default=None)
    advance_payment_amount: Decimal = Field(description='Advance payment amount')
...
class Payment(BaseModel):
    ...
    actual_amount: Decimal = Field(description='Actual payed amount')
    due_date: date = Field(description='Payment due date')
    actual_payment_date: Optional[date] = Field(description='Actual payment date', default=None)
